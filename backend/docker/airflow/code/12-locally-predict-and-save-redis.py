...
"""
dag = DAG(
    "12-Locally-Predict-And-Save-Redis",
...
"""
t3 = PythonOperator(
    task_id="save_data_redis_local",
    provide_context=True,
    python_callable=save_data_redis_local,
    op_kwargs={
        "REDIS_HOST": os.getenv("REDIS_HOST_L"),
        "REDIS_PORT": int(os.getenv("REDIS_PORT_L")),
        "REDIS_PASSWORD": os.getenv("REDIS_PASSWORD_L"),
    },
    dag=dag,
)
